...
import SearchField from "@/components/OnlyApp/SearchField";
...
interface ProfileThreadsHeaderProps {
  threads: Thread[];
}

function ProfileThreadsHeader({
  threads,
}: ProfileThreadsHeaderProps) {
...
export default ProfileThreadsHeader; 