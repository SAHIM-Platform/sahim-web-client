...
import { Ellipsis } from 'lucide-react';  // السطر 1
    ...
    >
      <div className="px-6 pt-6 pb-3 space-y-6">
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-2">  {/* السطر 20 */}
            <UserInfo
              photo={author.avatar}
              name={author.name}
              date={timestamp}
            />
            <Ellipsis className="w-5 h-5 cursor-pointer" />  {/* السطر 22 */}
          </div>
          <span className=
          
          "text-gray-500">{category}</span>  {/* السطر 25 */}
        </div>
